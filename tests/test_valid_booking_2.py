...
"""Это второй вариант тестов, в которых использованы фикстуры создания ID 
и удаления ID"""
...
class TestBookings:
    ...
    def test_patch_booking(self, auth_token, booking_data, patch_booking_data, del_booking_id):
        ...
        #Удаляем данные с помощью фикстуры del_booking_id
    ...
    def test_check_get_all_booking(self, auth_token, get_booking_id, bookingids, del_booking_id):
        # Создаем данные с помощью фикстуры get_booking_id
